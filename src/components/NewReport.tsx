      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <button
            ...
            className="w-full sm:w-auto px-3 py-2 bg-slate-800 text-white rounded-xl hover:bg-slate-900 transition-colors flex items-center gap-2 shadow-md flex-shrink-0"
          >
